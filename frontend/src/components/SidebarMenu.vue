...
const allMenuItems = [
  {
    name: 'Dashboard',
    route: '/dashboard',
    screenId: SYSTEM_SCREENS.DASHBOARD,  // 2000
  ...
  },
  {
    ...
    route: '/vehicle',
    screenId: SYSTEM_SCREENS.VISIT,  // 1100 (แก้จาก DATA_DAILY)
  ...
  },
  {
    name: 'Report',
    route: '/report',
    screenId: SYSTEM_SCREENS.REPORTS,  // 1000 (แก้จาก DATA_DAILY)
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>'
  },
  {
    name: 'Statistics',
    route: '/statistics',
    screenId: SYSTEM_SCREENS.STATISTICS,  // 3000
  ...
  },
  {
    name: 'Settings',
    route: '/settings',
    screenId: SYSTEM_SCREENS.SETTINGS,  // 10000
